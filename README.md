...
stateful components are always class components. dependent on its state object and can change it's own state. 

2. Describe the different phases of the component lifecycle.

componentdidmount = checks if a component has renderd on screen 

componentdidupdate = checks if a component has updated (state)

componentwillumount = executes before a component is destroyed 

3. Demonstrate an understanding of class component lifecycle methods.

4. Define stateful logic.

for example, custom hooks that can be reused for many components

5. Describe how to test a React component with React Testing Library.

check to see what happens if a user enters text, clicks a button, etc. 
